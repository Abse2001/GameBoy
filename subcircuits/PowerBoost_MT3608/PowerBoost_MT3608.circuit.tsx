...
export type PowerBoostMT3608Props = Omit<GroupProps, "children">
...
export const PowerBoost_MT3608 = ({
  ...
  <group
    ...
    name={name}
  >
    <net name="POWER_GND" isGroundNet />
    <net name="POWER_VBUS" isPowerNet />
    <net name="POWER_VSYS" isPowerNet />
    <net name="POWER_BAT_POS" isPowerNet />
    <net name="POWER_BAT_SWITCHED" isPowerNet />
    ...
    <trace from=".J_BAT > .pin1" to="net.POWER_BAT_POS" {...batteryTraceProps} />
    <trace
      from="net.POWER_BAT_SWITCHED"
      to=".Q_BAT_CUTOFF > .source"
      {...powerTraceProps}
    />
    <trace from="net.POWER_BAT_SWITCHED" to=".R_BOOST_EN_PULLUP > .pin1" />
    <trace
    ...
    <trace from=".Q_USB_BOOST_OFF > .pin3" to="net.POWER_GND" {...gndLabel} />
    <trace from="net.POWER_VBUS" to=".R_USB_BOOST_OFF > .pin1" {...vbusLabel} />
    <trace
    ...
    />
    <trace from="net.POWER_BAT_SWITCHED" to=".R_BAT_GATE_PULLUP > .pin1" />
    <trace
    ...
    <trace from=".Q_BAT_GATE > .pin3" to="net.POWER_GND" {...gndLabel} />
    ...
    <trace from=".R_BOOST_BOT > .pin2" to="net.POWER_GND" {...gndLabel} />
    <trace from=".J_BAT > .pin2" to="net.POWER_GND" {...gndLabel} />
  </group>
)
