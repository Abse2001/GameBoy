...
export const PicoGroup = (props: PicoGroupProps) => (
  <group name="PICO" {...props}>
...
<trace name="ADC_G" from=".C_ADC > .pin2" to="net.GND" {...gndLabel} />
    ...
    <resistor name="R_PWR_LED" resistance="330" footprint="0402" schSectionName={schSections.status} pcbX={-6.2} pcbY={24.8} pcbRotation={90} schOrientation="horizontal" schX={8.6} schY={-18.52} />
    ...
    <capacitor name="C_VBUS" capacitance="10uF" footprint="0603" schSectionName={schSections.usb} schOrientation="vertical" pcbX={-2.8} pcbY={26.3} pcbRotation={90} schX={15.47} schY={-3.96} />
