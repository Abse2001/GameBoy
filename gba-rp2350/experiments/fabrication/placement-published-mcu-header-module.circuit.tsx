...
export default ({
  ...
  <Board
    ...
    sharedSpiTracePaths={sharedSpiTracePaths}
    chainSharedSignalTraces={chainSharedSignalTraces}
    ...
    routeDecouplingFirst={routeDecouplingFirst}
    allGlobal
    layers={4}
    copperIslands={false}
