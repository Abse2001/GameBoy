...
export default ({
  ...
  >
    ...
    <AP2112K_3_3TRG1
      ...
      noConnect={["NC"]}
      {...ldoPlacements?.U_3V3}
      // Diodes' JLC library is rotated 90 degrees relative to the old alternate.
    ...
    {storage && publishedMcuModule && (
      <group name="STORAGE" schX={26} schY={32}>
        <MicroSDStorage name="SD" pcbX={gbaHousingFit ? 46 : 34} pcbY={gbaHousingFit ? -29 : -33.7} pcbRotation={180} sdDetectEscape={sdDetectEscape} hfCapRotation={sdHfCapRotation} />
