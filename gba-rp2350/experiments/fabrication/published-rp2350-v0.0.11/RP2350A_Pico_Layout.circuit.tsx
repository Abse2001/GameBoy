...
const rp2350InlineSchematicPinArrangement = {
	leftSide: [
		"VREG_VIN", "IOVDD6", "IOVDD5", "IOVDD4", "IOVDD3", "IOVDD2", "IOVDD1",
		"ADC_AVDD", "VREG_AVDD", "USB_OTP_VDD", "QSPI_IOVDD",
		"GPIO0", "GPIO1", "GPIO2", "GPIO3", "GPIO4", "GPIO5", "GPIO6", "GPIO7",
		"GPIO8", "GPIO9", "GPIO10", "GPIO11", "GPIO12", "GPIO13", "GPIO14", "GPIO15",
		"XIN", "XOUT", "SWCLK", "SWDIO", "RUN",
	],
	rightSide: [
		"GPIO16", "GPIO17", "GPIO18", "GPIO19", "GPIO20", "GPIO21", "GPIO22", "GPIO23",
		"GPIO24", "GPIO25", "GPIO26_ADC0", "GPIO27_ADC1", "GPIO28_ADC2", "GPIO29_ADC3",
		"USB_DM", "USB_DP", "QSPI_SD3", "QSPI_SCLK", "QSPI_SD0", "QSPI_SD2", "QSPI_SD1",
		"QSPI_SS", "VREG_LX", "VREG_FB",
	],
...
export interface RP2350AEssentialKiCadReferenceProps {
	...
	c18Placement?: { pcbX: number; pcbY: number; pcbRotation?: number };
	children?: ReactNode;
}
	...
	>
		...
		>
			<RP2350A
				...
				pcbY={-1.1}
				pcbRotation={0}
				schPinArrangement={inlineSignalLabels ? rp2350InlineSchematicPinArrangement : undefined}
