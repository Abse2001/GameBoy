...
<keepout shape="circle" pcbX="-2.889885mm" pcbY="1.05492555mm" radius="0.525mm" layers={["top", "inner1", "inner2", "bottom"]} excludeRefs={props.name ? [`.${props.name}`] : []} />
<keepout shape="circle" pcbX="2.890139mm" pcbY="1.05492555mm" radius="0.525mm" layers={["top", "inner1", "inner2", "bottom"]} excludeRefs={props.name ? [`.${props.name}`] : []} />
