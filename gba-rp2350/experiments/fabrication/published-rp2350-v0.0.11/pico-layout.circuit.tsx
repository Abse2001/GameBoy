  ...
  >
    ...
    >
      ...
      {psram && (
        <group name="EXTERNAL_RAM" schSheetName="interfaces" schX={9} schY={7}>
          ...
          <trace name="PSRAM_IO0" from=".U_PSRAM > .SIO0" to=".U1 > .QSPI_SD0" thickness="0.12mm" />
          <trace name="PSRAM_IO1" from=".U_PSRAM > .SIO1" to=".U1 > .QSPI_SD1" thickness="0.12mm" />
          <trace name="PSRAM_IO2" from=".U_PSRAM > .SIO2" to=".U1 > .QSPI_SD2" thickness="0.12mm" />
    ...
    {multiTerminalRunTrace ? (
      ...
      <>
        ...
        <trace name="RUN_SWITCH" from=".U_RUN > .pin1" to={chainRunTrace ? ".R_RUN > .pin1" : ".MCU_CORE .U1 > .RUN"} />
      </>
    )}
    ...
    {headers && leftHeaderSignals.map((signal, index) => signal === "V3V3_EN" ? null : (
    ...
    {headers && rightHeaderSignals.map((signal, index) => (
    ...
    <trace name="STEMMA_QT_3V3_ENTRY" from=".J_STEMMA_QT > .V3V3" to=".R_STEMMA_POWER > .pin2" {...powerTraceProps} />
    <trace name="STEMMA_QT_3V3" from=".R_STEMMA_POWER > .pin1" to="net.V3V3" {...v3v3Label} {...powerTraceProps} />
