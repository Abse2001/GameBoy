...
// Route the MCU as an independent daughterboard and let the parent board
// connect only to its physical headers. The oscillator remains an automatic
// first-phase route inside the MCU subcircuit.
export default () => (
  <StorageBoard
    mcuSubcircuit
    mcuHeaders
