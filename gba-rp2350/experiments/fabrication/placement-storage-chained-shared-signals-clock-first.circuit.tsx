...
// Preserve ordinary two-terminal traces while daisy-chaining the shared SPI
// nets through existing connector pads. Only one route reaches each dense MCU
// pad; Pipeline 9 generates every copper segment and via.
export default () => (
  <StorageBoard
    mcuSubcircuit={false}
    mcuHeaders={false}
